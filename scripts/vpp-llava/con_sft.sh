...
export output_dir=./checkpoints/llava-VPP_ep${num_train_epochs}_unfreezeVIT
export data_path=./playground/train_json/llava_v1_5_GRD_Chatterbox_genixer_revised.json
