...
from llava.model.multimodal_encoder.detr_queries.position_encoding import build_position_encoding
...
def build_backbone():
    ...
    backbone = Backbone('resnet101', return_interm_layers, dilation=False)
