...
from llava.model.multimodal_encoder.anchor_detr.row_column_decoupled_attention import MultiheadRCDA
...
def mask2pos(mask):
    not_mask = ~mask
    y_embed = not_mask[:, :, 0].cumsum(1, dtype=torch.bfloat16)
    x_embed = not_mask[:, 0, :].cumsum(1, dtype=torch.bfloat16)
